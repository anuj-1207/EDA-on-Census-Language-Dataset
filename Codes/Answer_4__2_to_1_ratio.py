...
Processed_data2 = Processed_data2.drop(columns=["3_to_2_Ratio"])
...
_2_to_1_Ratio = Processed_data2.iloc[[0,1,2,35,34,33],[0,1,2]]
_2_to_1_Ratio = _2_to_1_Ratio.reset_index()
_2_to_1_Ratio = _2_to_1_Ratio.drop(columns=["index"])
# display(_2_to_1_Ratio)
...
_2_to_1_Ratio.to_csv('2-to-1-ratio.csv')
